try {
    ! function () {
        ...
        var e = "___delivery___global___counter___";
        try {
            top.locaiton;
        ...
        s.setPath("https://dup.baidustatic.com/"), s.define({
            ...
            getPmpRequestUrl: function (t) {
                ...
                if (c) {
                    ...
                    var p = c.order_deliv;
                    p.deliv_id && "0" !== p.deliv_id && n.push("orderid=" + p.deliv_id), p.demand_id && "0" !== p.demand_id && n.push("odid=" + p.demand_id);
                    var u = c.rtb_deliv;
                    u.deliv_id && "0" !== u.deliv_id && n.push("rtbid=" + u.deliv_id), u.demand_id && "0" !== u.demand_id && n.push("rdid=" + u.demand_id);
            ...
            cloneSlot: function (t) {
                ...
                return e = window.JSON && window.JSON.parse ? JSON.parse(JSON.stringify(t)) : this.lang.clone(t),
                    e.index = this.counter.slotCountIndex[e.slotId], this.counter.slotCountIndex[e.slotId] = this.counter.slotCountIndex[e.slotId] + 1, e.id = e.slotId + "_" + e.index, e
            },
            ...
            setStatus: function (t, e) {
                ...
                if (i && (i.status |= e), (e & this.config.STATUS_CREATE) > 0) try {
                    var n = window.require;
                    n && n("performance") && n("performance").getTiming() && n("performance").getTiming().MIPStart ? this.storageTime[t] = parseInt(n("performance").getTiming().MIPStart, 10) : this.storageTime[t] = ""
                } catch (o) {
                    this.storageTime[t] = ""
                }
                if ((e & this.config.STATUS_FINISH) > 0) {
                    if ("113006" === i.exps || "112002" === i.exps) {
                        var s = this.storageTime[t] ? (new Date).getTime() - this.storageTime[t] : "-1",
                            r = {
                                type: "mip",
                                id: t,
                                mes: s,
            ...
            onMessageHandler: function (t) {
                ...
                e && e.placement && e.placement.update && e.queryid && e.tuid && (this.updateInfo(e), e.tuid.indexOf("u") > -1 && e.noadx && parseInt(e.noadx, 10) && this.unionAdIsAvailable(e))
            },
            ...
            unionAdIsAvailable: function (t) {
                ...
                if (e) {
                    var i = this.dom.g(e.containerId),
                        n = s.using("dup.business.viewWatch"),
            ...
            processSlotInfo: function (t) {
                ...
                if (t.styleOpenApi) {
                    ...
                    var p = c.cpro_w || c.rsi0 || 0,
                        u = c.cpro_h || c.rsi1 || 0;
                    (p || u) && (r = 1, a = p || this.getCurViewportWidth(a), d = u || d)
                }
            ...
            regisetViewWatch: function (t) {
                ...
                if (e) {
                    ...
                    if (window.postMessage && c.slotId && c.slotId.indexOf("u") > -1) {
                        ...
                        if (h && h.length) {
                            var p = h[0];
                            c.watchIframe = p, c.targetOrigin = p.getAttribute("src") || "*";
                            try {
                                c.watchIframeWindow = p.contentWindow
                            } catch (u) {
                                c.watchIframeWindow = ""
                            }
            ...
            expandAd: function (t) {
                if (!this.expandStatus[t]) {
                    ...
                    if (1 === c || 2 === c ? (u.setAttribute("height", a), u.style.height = a + "px") : 3 !== c && 4 !== c || (u.setAttribute("width", r), u.style.width = r + "px"), 2 == l && 2 == c || 2 == l && 4 == c) switch (c) {
                        case 2:
                ...
                if ("success" !== e) {
                    ...
                    if (i)
                        if (n.type && "rich" === n.type) {
                            var p = this.material.formatMaterial(n, i),
            ...
            processFrameData: function (t) {
                ...
                if (c) e = c;
                    ...
                    this.data.defineOnce(u, s.proxy(this, this.cacheRequestCallback)), this.data.defineOnce(p, s.proxy(this.requestCache, this.requestCache.cacheRequest)), e = this.param.getPmpRequestUrl(t), n = 'onload="' + p + "('" + t.paramObj.dpv + "', this);\""
