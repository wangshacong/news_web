        ...
        <div class="content">
            ...
            <xblock>
                <!--<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button>--><button
                    class="layui-btn"><a href="/cxjy_admin/news4/create"><i class="layui-icon">&#xe608;</i>添加</a></button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="/cxjy_admin/news4/{{$v['id']}}/edit">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a href="/cxjy_admin/news4/{{$v['id']}}/destroy" onClick="delete_confirm">删除</a>
