...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            ...
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="/cxjy_admin/news4/{{$article['id']}}/update" method="post" enctype="multipart/form-data">
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2017 x-admin v2.4 All Rights Reserved. 本后台系统由X前端框架提供前端技术支持</div>
</div>
<!-- 底部结束 -->
<!-- 背景切换开始 -->
