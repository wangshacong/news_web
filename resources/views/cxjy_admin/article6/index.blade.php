        ...
        <div class="content">
            ...
            <xblock>
                <!--<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button>--><button
                    class="layui-btn"><a href="/cxjy_admin/news6/create"><i class="layui-icon">&#xe608;</i>添加</a></button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><u style="cursor:pointer" onclick="<!--member_show('张三','member-show.html','10001','360','400')-->"><a
                                    href="http://www.xmscxw.com/article/{{$v['id']}}" target="_blank">{{$v['title']}}</a></u></td>
                        <td>{{$v['zuozhe']}}</td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="/cxjy_admin/news6/{{$v['id']}}/edit">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a href="/cxjy_admin/news6/{{$v['id']}}/destroy" onClick="delete_confirm">删除</a>
