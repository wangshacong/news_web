    ...
    <div class="page-content">
        <div class="content">
            ...
            <xblock>
                ...
                <a href="/cxjy_admin/user/create"><button class="layui-btn"><i class="layui-icon">&#xe608;</i>添加</button></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="/cxjy_admin/user/{{$v['id']}}/update">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="/cxjy_admin/user/{{$v['id']}}/destroy" onClick="delete_confirm">删除</a>
